...
export default function CreateListingPage() {
  ...
  return (
    <div className="max-w-2xl mx-auto">
      <div className="mb-6">
        <Link href="/admin" className="flex items-center text-sm text-slate-500 hover:text-slate-900 mb-2">
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <p className="text-xs text-slate-400">
                Note: Configure NEXT_PUBLIC_CLOUDINARY_CLOUD_NAME in .env.local to enable uploads.
              </p>
            </div>
